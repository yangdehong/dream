...
public class JdbcUtil {
    //url
    private static String url = "jdbc:mysql://rm-bp14m38byen9x1gs3mo.mysql.rds.aliyuncs.com:3306/ydh_test?useUnicode=true";
    //user
    private static String user = "ai_call_engine";
    //password
    private static String password = "#Daily_ai_call_engine";
    //驱动程序类
